...
def transformer_model(tokenizer, maxlen, neurons = 60, embedding_path = '../embeddings/embeddings-l-model.vec'):
...
model = transformer_model(neurons = 40, tokenizer = tokenizer, maxlen = maxlen)
