...
CSV_Path1 ="../data_augmentation/Train-google-en_ses.csv"
CSV_Path2 ="../data_augmentation/Test-google-en_ses.csv"
...
def create_model(neurons=20, momentum=0.9):
  ...
  mod.add(Conv1D(500, 4, activation='relu'))
  mod.add(Flatten())
  mod.add(Dense(neurons, activation='relu', kernel_initializer='he_uniform', kernel_regularizer=keras.regularizers.l1(0.01),bias_regularizer='l1'))
  mod.add(Dropout(0.2))
